...
async function _summarizeWithOllamaInternal(bodyText, title, publishedAt) {
  ...
  try {
    ...
    각 문장 사이에는 줄바꿈(\\n)을 넣어라.
    각 문장의 끝은 반드시 '~함', '~임' 대신에 '체결', '제공', '추진', '완료', '예정' 등과 같이 **명사 그 자체로 종결**하라.
    ...
    - summary: 핵심 내용을 요약하여 최대 4개의 명사형 문장을 배열 형식으로 작성하세요. 문장 끝은 반드시 명사(예: 체결, 제공, 추진, 예정, 완료)로 끝나야 합니다. 1., 2. 같은 숫자를 문장 앞에 절대 넣지 마세요.
