...
async function _summarizeWithOllamaInternal(bodyText, title, publishedAt) {
  ...
  try {
    ...
    **가장 중요한 규칙**: 각 문장의 끝은 반드시 '~함', '~임', '~다' 대신에 '체결', '제공', '추진', '완료', '예정' 등과 같이 **명사 그 자체로 종결**하라.
    
    예시:
    - 구글 클라우드와 AI 인프라 계약 체결
    - 엔비디아 최신 칩 기반 시스템 제공
    - 차세대 AI 모델 공개 예정
    ...
    - summary: 핵심 내용을 요약하여 최대 4개의 명사형 문장을 작성하세요. 문장 끝은 반드시 명사(예: 체결, 제공, 추진, 예정, 완료, 분석, 도입)로 끝나야 합니다. '~다', '~음', '~함'으로 끝나면 절대 안 됩니다.
